...
// //   console.error("Order validation failed:", parsedOrder.error.format());
// //   throw new Error("Invalid order data. Please check your input.");
// // }

// // return await Order.create(parsedOrder.data);
...
//     // Recalculate price & delivery date on the server
...
//   // Recalculate delivery date and price
//   const updatedCart = await calcDeliveryDateAndPrice({
//     items: clientSideCart.items,
//     shippingAddress: clientSideCart.shippingAddress,
//     deliveryDateIndex: clientSideCart.deliveryDateIndex,
//   })

//   const cart = { ...clientSideCart, ...updatedCart }
...
//   if (!deliveryDate) throw new Error('Invalid delivery date selection')
...
//   const taxPrice = round2(itemsPrice * 0.15)
//   const totalPrice = round2(itemsPrice + (shippingPrice ? round2(shippingPrice) : 0) + round2(taxPrice))

//   return {
//     expectedDeliveryDate:AVAILABLE_DELIVERY_DATES, // ✅ Ensure correct property is returned
//     deliveryDateIndex:
//       deliveryDateIndex === undefined ? AVAILABLE_DELIVERY_DATES.length - 1 : deliveryDateIndex,
//     itemsPrice,
//     shippingPrice,
