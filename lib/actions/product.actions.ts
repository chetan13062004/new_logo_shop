...
export async function getProductsByTag({
  ...
  try {
    ...
    // Fetch the products from MongoDB
    ...
    // Map the data to match the IProduct interface
    const products = productsData.map((product) => ({
      _id: product._id.toString(),  // Ensure _id is converted to string if necessary
      name: product.name,
      brand: product.brand,
      price: product.price,
    ...
    // Return the products as IProduct[]
